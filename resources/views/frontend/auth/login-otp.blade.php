            ...
            <div class="col-lg-7 col-xl-6">
                <div class="card border-0 shadow-lg rounded-4 overflow-hidden">
                    <div class="card-body p-5 p-md-5">
                        <div class="mb-4">
                            <span class="badge bg-primary-subtle text-primary mb-2">Step 2 of 2</span>
                            <h3 class="mb-2">Verify login code</h3>
                            <p class="text-body-secondary mb-0">We sent a 6-digit code to {{ $email }}. Enter it to finish login.</p>
                        </div>
                        ...
                        <form method="POST" action="{{ route('user.login.otp.verify') }}" class="row g-3">
                            @csrf
                            <div class="col-12">
